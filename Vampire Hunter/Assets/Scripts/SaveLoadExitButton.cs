...
public class SaveLoadExitButton : MonoBehaviour
{
    [Header("Button Settings")]
    [Tooltip("ButtonMode: 'save' saves game, 'load' loads game, 'exit' saves game and exits")]
